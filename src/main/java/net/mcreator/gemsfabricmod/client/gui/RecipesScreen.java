...
import net.mcreator.gemsfabricmod.network.RecipesButtonMessage;
...
public class RecipesScreen extends AbstractContainerScreen<RecipesMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("gems_fabric_mod:textures/screens/recipes.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.gems_fabric_mod.recipes.label_recipes"), 68, 19, -39424, false);
	}
	...
	public void init() {
		super.init();
		button_next = Button.builder(Component.translatable("gui.gems_fabric_mod.recipes.button_next"), e -> {
			if (true) {
				GemsFabricModMod.PACKET_HANDLER.sendToServer(new RecipesButtonMessage(0, x, y, z));
